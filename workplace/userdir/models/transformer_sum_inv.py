...
@register_model('transformer_sum_inv')
class TransformerSumInvModel(FairseqEncoderDecoderModel):
    """
...
@register_model_architecture('transformer_sum_inv', 'transformer_sum_inv')
